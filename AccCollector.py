...
class AccCollector():
    def __init__(self, baseDir = "1027_brutL3L4"):
...
if __name__=="__main__":
    ...
    # accC = AccCollector("1027_brutL3L4")
    # accC.addExp("1028_2brutL3L4", color="red", dataset="val", title="1028_2brutL3L4")
    # accC.addExp("1029_brutL3L4", color="green", dataset="val", title="1029_brutL3L4")
    # accC.addExp("1103_brutL3L4", color="blue", dataset="val", title="1103_brutL3L4")
    # accC.savePlt(dataset="val")
    accC = AccCollector("1027_brutL3L4")
